...
export default function LegalNotices() {
  return (
    <>
      <Head>
        <title>Nata - Politique de confidentialité</title>
        <meta
          name="description"
      ...
      <>
        <section className="fr-container">
          ...
          >
            <p>
              Nata est développé au sein de la Fabrique numérique des ministères
              sociaux, avec l&apos;appui de l&apos;Agence régionale de santé
              Île-de-France. Nata permet aux patients atteints de
              Bronchopneumopathie Chronique Obstructive en stade avancé de
              prévenir les exacerbations et d&apos;éviter les hospitalisations
              en apprenant à observer l&apos;évolution de leurs symptômes
              cliniques quotidiennement.
            </p>

            <div>
              <p>Nata manipule les données personnelles suivantes :</p>
            ...
            <p>
              ...
              santé et de la prévention, à l&apos;ARS ou à l&apos;équipe Nata.
              Toutes les données sont maintenues dans l&apos;appareil en local
              de l&apos;utilisateur. Par ailleurs, nous ne sommes pas en mesure
